...
# -*- coding: utf-8 -*-
"""
Created on Thu Jun 27 21:03:19 2019
...
class DecoderBlock(nn.Module):
    def __init__(self, in_channels, n_filters):
        ...
        self.deconv2 = nn.ConvTranspose2d(in_channels // 4, in_channels // 4, 3, stride=2, padding=1, output_padding=0)
...
class CE_Net_(nn.Module):
    def __init__(self, num_classes=2, num_channels=3):
        ...
        resnet.load_state_dict(torch.load("/home/chenzj/ISIC/deeplabv3/pretrained_models/resnet/resnet34-333f7ec4.pth"))
        ...
        self.finaldeconv1 = nn.ConvTranspose2d(filters[0], 32, 3, 2, 1)
