...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1):
        ...
        if stride != 1:
            downsample = nn.Sequential(
                ##
                nn.AvgPool2d(2, stride=2, padding=0, ceil_mode=True, count_include_pad=True),
    ...
    def _load_pretrained_model(self):
        if self.layers[2] == 6:
            ...
            pretrain_dict = torch.load("/home/chenzj/ISIC/deeplab-xception/pretrained_models/resnet50-19c8e357.pth")
        elif self.layers[2] == 23:
